...
use core_text::font_descriptor::{
    CTFontDescriptor, kCTFontDefaultOrientation, kCTFontVariationAttribute,
};
...
use crate::types::ResourceCacheError;
        ...
        objc::rc::autoreleasepool(|| {
            ...
            let (antialias, smooth, text_color, bg_color, invert) = match glyph_type {
                ...
                GlyphType::Vector => match (font.render_mode, use_font_smoothing) {
                    ...
                    (FontRenderMode::Alpha, false) => {
                        (true, false, ColorF::BLACK, ColorF::WHITE, true)
                    }
